...
def error(y_test,y_predicted, x_train, x_test, y_train, Model):
    ...
    print(test_set_acc)
    return(r2,mse,train_set_acc,test_set_acc)
...
[r2_lr,mse_lr,train_set_acc_lr,test_set_acc_lr]=error(y_test,y_predicted_Lr, x_train, x_test, y_train, lrModel)
errorLr=[train_set_acc_lr,test_set_acc_lr,r2_lr,mse_lr,a_lr,b_lr]

[x_train_poly2, x_test_poly2, y_poly2_predicted, a_p2,b_p2,model_poly2]=polinomial(2,x_train, y_train, x_test)
[r2_p2,mse_p2,train_set_acc_p2,test_set_acc_p2]=error(y_test,y_poly2_predicted, x_train_poly2, x_test_poly2, y_train, model_poly2)
errorPoly2=[train_set_acc_p2,test_set_acc_p2,r2_p2,mse_p2,a_p2,b_p2]

[x_train_poly5, x_test_poly5, y_poly5_predicted, a_p5,b_p5,model_poly5]=polinomial(5,x_train, y_train, x_test)
[r2_p5,mse_p5,train_set_acc_p5,test_set_acc_p5]=error(y_test,y_poly5_predicted, x_train_poly5, x_test_poly5, y_train, model_poly5)
errorPoly5=[train_set_acc_p5,test_set_acc_p5,r2_p5,mse_p5,a_p5,b_p5]

[x_train_poly25, x_test_poly25, y_poly25_predicted, a_p25,b_p25,model_poly25]=polinomial(25,x_train, y_train, x_test)
[r2_p25,mse_p25,train_set_acc_p25,test_set_acc_p25]=error(y_test,y_poly25_predicted, x_train_poly25, x_test_poly25, y_train, model_poly25)
errorPoly25=[train_set_acc_p25,test_set_acc_p25,r2_p25,mse_p25,a_p25,b_p25]


#EXPORTO LOS DIFERENTES ERRORES A CSV PARA PODER COMPARARLOS
erroresNombre=["Precision sobre set de Train", "Precision sobre set de Test", "R cuadrado", "Error cuadratico medio (MSE)", "Valores de coeficientes a","Valor de interseccion b"]
...
nombre_resultados="ResultadosEvaluacionModeloLrP2525.csv"
